...
macOS (Intel): download `MonoCode_x64.dmg` from [GitHub Releases](https://github.com/kaceper11/monocode/releases/latest), open it, and drag MonoCode to Applications.
